<template>
  ...
  >
    <v-btn icon variant="text" class="menu-item" :to="{ name: 'Home' }">
    ...
    <v-btn icon variant="text" class="menu-item" :to="{name:'ReporterNews'}">
    ...
    <v-btn icon variant="text" class="menu-item" :to="{ name: 'News' }">
